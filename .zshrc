...
alias gplroh='git pull --rebase origin HEAD'
alias gps='git push'
...
alias pamcm='php artisan make:component'
alias pamcn='php artisan make:controller'
alias pamcn='php artisan make:controller'
alias pami='php artisan migrate'
alias pamir='php artisan migrate:refresh'
alias pamirseed='php artisan migrate:refresh --seed'
